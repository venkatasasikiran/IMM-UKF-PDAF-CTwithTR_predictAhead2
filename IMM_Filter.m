function [FilterEstimate,transWave,Measurements] = IMM_Filter(ParPath,ParGen,Timings,Measurements,...
                                                        ClutterStruct,caseLoop,ParStdDev,trueTransWave)
    ...
    for i = 1:n
        ...
        transWave(i,:) = Planner_Est(FilterPredict,ParPath,caseLoop);           
