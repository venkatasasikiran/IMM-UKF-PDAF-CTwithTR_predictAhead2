function [FilterEstimate,transWave,Measurements] = IMM_Filter2(ParPath,ParGen,Timings,Measurements,...
    ...
    FilterEstimate.Update = zeros(min(stateSizeCV,stateSizeCT),n-1);
    FilterEstimate.Predict = zeros(min(stateSizeCV,stateSizeCT),n);
    ...
    for i = 2:n
        ...
        if i == 2                                                                            
            ...
            FilterEstimate.Predict(:,1) = FilterPredict;
        ...
        FilterEstimate.Predict(:,i) = FilterPredict;
        ...
        [FilterEstimateCV,FilterEstimateCTpos,FilterEstimateCTneg,z,LambdaAll] = Update_States_Clutter_Adjust(FilterEstimateCV,FilterEstimateCTpos,FilterEstimateCTneg,...
                                                                                         FilterMat,Measurements,ClutterStruct,transWave(i-1),ParPDAF,i-1);
       
        modeProb = Update_Mode_Prob(LambdaAll,cNorm);
        FilterEstimate.Update(:,i-1) = FilterEstimateCV.XkPlus*modeProb(1) + FilterEstimateCTpos.XkPlus*modeProb(2)...
